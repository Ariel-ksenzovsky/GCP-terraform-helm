...
def display_images():
    try:
        ...
        response = make_response(render_template('index.html', image=image_url, visitor_count=visitor_count))

        # Prevent caching of the page itself (including the visitor count)
